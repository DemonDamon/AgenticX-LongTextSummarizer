...
本目录存放 AgenticX 长文本摘要示例的分阶段实施 plan（由仓库根 `.cursor/plans/` 迁移至此，便于与 example 同目录维护）。

## 阅读顺序

| 阶段 | Plan 文件 |
|------|-----------|
| 总览 | `2026-06-17-longtext-summarizer-overview.plan.md` |
| Phase 1 基础集成 | `2026-06-17-longtext-summarizer-phase1-foundation.plan.md` |
